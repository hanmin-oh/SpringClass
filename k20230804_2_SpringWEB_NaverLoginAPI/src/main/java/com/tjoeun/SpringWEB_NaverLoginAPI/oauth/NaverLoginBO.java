package com.tjoeun.SpringWEB_NaverLoginAPI.oauth;
...
//	네이버 로그인 API 등록시 발급받은 Client ID , Client Secret과 Callback URL을 입력한다.
	private final static String CLIENT_ID = "AUIu2IId2SMp2YMGPjp4";
	private final static String CLIENT_SECRET = "1LAooE442Z";
	private final static String REDIRECT_URI = "http://localhost:8080/SpringWEB_NaverLoginAPI/callback";
