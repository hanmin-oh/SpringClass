...
public class MainClass {
	...
	public static void main(String[] args) {
		...
		// DI 컨테이너를 다시 만들어 환경 설정 정보를 얻어오면 addLast() 메소드를 사용해 추가한 properties 정보가 없기 때문에
		// ConfigurableApplicationContext 인터페이스 타입 객체의 환경 설정 정보를 그대로 사용하기 위해서 xml 파일에서 bean 설정
		// 정보를 얻어오는 GenericXmlApplicationContext 클래스 타입으로 형변환 시켜 사용한다. => 기존의 DI 컨테이너를 그래도 사용
